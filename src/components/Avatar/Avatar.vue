...
import { Anonymous, Busy, Focus, Offline, Online, Approve, Decline, Locked } from './icons';
...
const presenceClass = cva('absolute bottom-0 bg-[#282E33] rounded-full border border-[#282E33]', {
  variants: {
    appearance: {
      circle: '',
      square: '',
